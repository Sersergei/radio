...
class EmailActive
{
    ...
    public function email(){
        ...
        if($this->user->saveAttributes(array ('activate'))) {
            ...
            $text=$text.'<br><br><br>'.Yii::t('radio','If you wanna change settings your profile').'<a href ='.$hrefUpdate.'>'.Yii::t('radio','click here').'</a><br><br><br><a href ='.$hrefUnscribe.'>'.Yii::t('radio','Unscribe').'</a>';
