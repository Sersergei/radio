...
class SiteController extends Controller
{
	...
	public function actionLogin()
	{
		...
		if(isset($_POST['LoginForm']))
		{
			...
			if($identity->authenticate()) {
				...
				Yii::app()->user->setFlash('error',Yii::t('radio','ÐÐµÐ¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¾Ðµ Ð¸Ð¼Ñ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ Ð¸Ð»Ð¸ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ'));
		}
	...
	public function actionRun()
	{
		...
		if (isset($_POST['ConfigForm'])) {
			...
			if($model->save($path))
			{
				Yii::app()->user->setFlash('success config', 'Êîíôèãóðàöèÿ ñîõðàíåíà');
				$this->refresh();
			}
		}
